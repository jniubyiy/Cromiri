...
class MainTabsBox(Box):
    ...
    def create_widget(self, parent=None):
        ...
        self.tab_bar.addTab(self.settings.tr("main_tabs.history"))
        self.tab_bar.addTab(self.settings.tr("main_tabs.bookmarks"))
    ...
    def retranslate_ui(self):
        if self.tab_bar:
            ...
            self.tab_bar.setTabText(1, self.settings.tr("main_tabs.history"))
            self.tab_bar.setTabText(2, self.settings.tr("main_tabs.bookmarks"))
            self.tab_bar.setTabText(3, self.settings.tr("main_tabs.settings"))
            self.tab_bar.setTabText(4, self.settings.tr("main_tabs.scripts"))