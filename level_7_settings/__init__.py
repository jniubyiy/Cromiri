...
# Объявления для автоопределения
DEPS = []
WRAPPER_CLASS = "SettingsLevelWrapper"
...
class SettingsLevelWrapper(LevelWrapper):
    def __init__(self):
        ...
        super().__init__(core)
        core.setup_boxes()
        self.register_public_api("load_settings", "save_settings", "get", "set", "tr", "available_languages", "load_language", "get_current_lang", "save")
        self.allow_request_from("*", ["load", "save", "validate", "set_data", "get", "set", "tr", "available_languages", "load_language", "get_current_lang"])
